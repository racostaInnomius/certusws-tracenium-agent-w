// privsvc/macos/src/cdp-acme-http01.ts
//
...
import { handleHttp01, MACOS_DEFAULT_ROOTS } from "../../shared/acme-http01";
...
export function handleCdpAcmeHttp01(req: PrivSvcRequest): PrivSvcResponse {
  const out = handleHttp01(req.params || {}, { roots: MACOS_DEFAULT_ROOTS, extraRootsFile: path.join(DATA_DIR, "acme-webroots") });
  if (!out.ok) {
