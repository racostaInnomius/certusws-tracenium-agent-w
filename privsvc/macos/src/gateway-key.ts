// privsvc/macos/src/gateway-key.ts
//
...
// (`digitalSignature`) del mismo certificado. macOS simplemente no lo
// comprueba, porque la clave vive en un fichero PEM y no en el llavero.
// Un mecanismo que depende de que nadie mire se rompe el día que alguien
// mira.
//
