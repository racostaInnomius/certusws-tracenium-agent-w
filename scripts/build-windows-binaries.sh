...
# release version (1.1.19 etc.) instead of the SDK's default 1.0.0.0.
#
...
# FileVersion=1.0.0.0 while the surrounding MSI said 1.1.19, which
...
# we strip any semver pre-release suffix (e.g. "1.1.19-rc1" → "1.1.19")
