...
#   .\tracenium-rescue-windows.ps1 -MsiPath C:\path\to\Tracenium-Agent-1.1.15-x64.msi
#
# What it does:
...
Write-Host ""
Write-Host "✓ Rescue complete. Device should report 1.1.15 to backend within 1-2 min." -ForegroundColor Green
Write-Host "  Verify in the portal that this device now shows agent_version 1.1.15."
