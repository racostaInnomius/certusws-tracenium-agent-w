...
export const LINUX_PROBE_KINDS = ["kmod", "mount", "unit", "pkg", "file", "files", "conf", "lines", "sysctl", "sshd", "users", "fs", "dconf", "ini", "listen", "net", "grub", "auditd", "aide", "banner", "proc", "sshkeys", "apt", "sudo"] as const;
